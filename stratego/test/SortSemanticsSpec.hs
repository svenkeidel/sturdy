...
spec = do
  ...
  where
    ...
    dropNegativeBindings (F.Success (E.Success (env,a))) = (F.Success (E.Success ( env,a)))
    dropNegativeBindings (F.Success (E.SuccessOrFail e (env,a))) = (F.Success (E.SuccessOrFail e (env,a)))
