...
/**
     ...
     */(s),2))[0],c=r[1]),this.engine.listen(this.namespaceId,i,s,c,(function(e){o.factory.scheduleListenerCallback(e._data||-1,n,e)}))}return this.delegate.listen(e,t,n)},t}(f),g=function(e){function n(t,n,r){return e.call(this,t.body,n,r)||this}return s(n,e),n.decorators=[{type:t.Injectable}],n.ctorParameters=function(){return[{type:void 0,decorators:[{type:t.Inject,args:[i.DOCUMENT]}]},{type:o.AnimationDriver},{type:o.ɵAnimationStyleNormalizer}]},n}(o.ɵAnimationEngine);function _(){return o.ɵsupportsWebAnimations()?new o.ɵWebAnimationsDriver:new o.ɵCssKeyframesDriver}function b(){return new o.ɵWebAnimationsStyleNormalizer}function v(e,t,n){return new m(e,t,n)}var A=new t.InjectionToken("AnimationModuleType"),w=[{provide:r.AnimationBuilder,useClass:d},{provide:o.ɵAnimationStyleNormalizer,useFactory:b},{provide:o.ɵAnimationEngine,useClass:g},{provide:t.RendererFactory2,useFactory:v,deps:[n.ɵDomRendererFactory2,o.ɵAnimationEngine,t.NgZone]}],C=c([{provide:o.AnimationDriver,useFactory:_},{provide:A,useValue:"BrowserAnimations"}],w),I=c([{provide:o.AnimationDriver,useClass:o.ɵNoopAnimationDriver},{provide:A,useValue:"NoopAnimations"}],w),N=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{exports:[n.BrowserModule],providers:C}]}],e}(),k=function(){function e(){}return e.decorators=[{type:t.NgModule,args:[{exports:[n.BrowserModule],providers:I}]}],e}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.ANIMATION_MODULE_TYPE=A,e.BrowserAnimationsModule=N,e.NoopAnimationsModule=k,e.ɵAnimationRenderer=y,e.ɵAnimationRendererFactory=m,e.ɵBrowserAnimationBuilder=d,e.ɵBrowserAnimationFactory=p,e.ɵInjectableAnimationEngine=g,e.ɵangular_packages_platform_browser_animations_animations_a=_,e.ɵangular_packages_platform_browser_animations_animations_b=b,e.ɵangular_packages_platform_browser_animations_animations_c=v,e.ɵangular_packages_platform_browser_animations_animations_d=C,e.ɵangular_packages_platform_browser_animations_animations_e=I,e.ɵangular_packages_platform_browser_animations_animations_f=f,Object.defineProperty(e,"__esModule",{value:!0})}));